...
public class DocumentDaoImplTest {
  ...
  public void testExists() throws Exception {
    ...
    boolean result = instance.exists(identifier);// this is kinda a nonsense test, as the UUID does
                                                 // not get set until after document creation
    assertEquals(expResult, result);
    Identifier toCheck =
        instance.create(TestUtils.getTestTable(), TestUtils.getTestDocument()).getId();
    expResult = true;
