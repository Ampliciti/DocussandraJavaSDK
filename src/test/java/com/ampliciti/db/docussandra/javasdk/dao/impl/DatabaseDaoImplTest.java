...
public class DatabaseDaoImplTest {
  ...
  public void testReadAll() throws Exception {
    ...
    // test2.description("second descript");//TODO: this is probably a bug in the open source
    // version of Docussandra
  ...
  public void testUpdate() throws Exception {
    ...
    entity
        .setDescription("This is a new database description. It should be different than before.");
